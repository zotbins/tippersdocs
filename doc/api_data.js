define({ "api": [
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Example Usage:",
        "content": "curl -X POST -i -H \"Content-Type:application/json\" -H \"Accept:application/json\" -d \"[{'timestamp': '2018-03-01 00:00:00', 'payload': {'weight': 123.456}, 'sensor_id': 'ZBin1', 'type': 2}]\" http://sensoria.ics.uci.edu:8059/observation/add",
        "type": "curl"
      }
    ],
    "parameter": {
